...
export default function CreatePostDialog({
  ...
  return (
    <div className="fixed inset-0 overflow-hidden z-50 flex items-center justify-center bg-black/50">
      <div
        ref={modalRef}
        className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-card text-card-foreground border border-border rounded-lg shadow-lg"
      >
        {/* Close button */}
        <button
          onClick={closeModal}
